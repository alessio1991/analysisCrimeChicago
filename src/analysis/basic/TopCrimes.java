...
public class TopCrimes implements java.io.Serializable {
	...
	public void run() {
		...
		JavaPairRDD<String, Integer> typeOfCrime = documents.flatMapToPair(
				t-> {
					String key = ((String)t._2.get("Primary Type")).trim();
		...
		JavaPairRDD<String, Integer> count = typeOfCrime.reduceByKey(
				(a, b) -> a + b);
		
		//sort the type of crimes by number of crimes
		...
		outputConfig.set("mongo.output.uri",
				"mongodb://localhost:27017/bigData.topcrimes");
